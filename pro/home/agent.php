...
<div class="column">
<a href="/pro/agent/add_registration.php"><img src="/pro/img/search1.png" alt="Register Vehicles"></a><br></br>
<label style="font-size:25px;color:white" >Register Vehicles</label>
</div>
<div class="column">
<a href="/pro/agent/rejected_registrations.php"><img src="/pro/img/reject.png" alt="Rejected Registrations"></a><br></br>
<label style="font-size:25px;color:white" >Rejected Registrations</label>
</div>
<div class="column">
