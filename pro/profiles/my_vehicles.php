...
$sql = "select aadhaar from user where username like '$un'";
...
$sql_1 = "SELECT vehicles.vin, vehicles.colour, vehicles.vendor, vehicles.name, vehicles.model, vehicles.man_year, vehicles.vtype, vehicles.wsize, registration.registernumber, registration.vin, registration.aadhaar
FROM vehicles
INNER JOIN      
registration
on vehicles.vin = registration.vin
WHERE registration.aadhaar like '$aadhaar'";
