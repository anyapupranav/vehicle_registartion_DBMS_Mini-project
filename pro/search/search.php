...
if ($searchid == "vin"){
$sql = "SELECT user.firstname, user.lastname, user.mobile, user.aadhaar, user.email, user.gender, registration.vin, registration.aadhaar
FROM user 
INNER JOIN      
registration
on user.aadhaar = registration.aadhaar
...
$sql_1 = "SELECT vehicles.colour, vehicles.vendor, vehicles.name, vehicles.model, vehicles.man_year, vehicles.vtype, vehicles.wsize, vehicles.vin, registration.vin, registration.aadhaar
FROM vehicles 
