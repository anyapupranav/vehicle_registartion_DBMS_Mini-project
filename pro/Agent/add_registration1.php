...
$sql = "INSERT INTO user (firstname, lastname, email, mobile, gender, aadhaar) VALUES ('$firstname', '$lastname', '$email', '$mobile', '$gender', '$aadhaar')";
$conn->query($sql);
...
$conn->query($sql_1);
$sql_2= "INSERT INTO Registrationsrequest (aadhaar, vin) VALUES ('$aadhaar', '$vin')";
$conn->query($sql_2);
