...
$sql_1 = "SELECT vehicles.colour, vehicles.vendor, vehicles.name, vehicles.model, vehicles.man_year, vehicles.vtype, vehicles.wsize, registrationsrequest.vin, registrationsrequest.aadhaar
FROM vehicles 
...
$sql_2 = "select user.firstname, user.lastname, user.email, user.gender, user.mobile, registrationsrequest.vin, registrationsrequest.aadhaar
FROM user
INNER JOIN registrationsrequest
on user.aadhaar=registrationsrequest.aadhaar
WHERE registrationsrequest.vin like '$search'";
...
<table>
  ...
  <tr>
    ...
    <th><input type="text" id="role" name="aadhaar" value="<?php echo $aadhaar?>"></th>
  </tr>
  <tr>
    <td>EMAIL</td>
