...
$aadhaar = $mysqli->real_escape_string($_REQUEST['aadhaar']);
$gender = $mysqli->real_escape_string($_REQUEST['gender']);
$roles = $mysqli->real_escape_string($_REQUEST['roles']);

$password = md5($pass.$pass);

$sql = "INSERT INTO user (firstname, lastname, username, email, password, mobile,aadhaar,gender, roles) VALUES ('$firstname', '$lastname', '$username', '$email', '$password', '$mobile', '$aadhaar', '$gender', '$roles')";
